...
export const MAKES = [
  'All Makes',
  'Alfa Romeo','AMC','Auburn','Austin','Austin Healey','BMW','Buick','Cadillac','Chevrolet','Chrysler','Datsun','De Tomaso','DeSoto','Dodge','Factory Five','Fiberfab','Ford',
  ...
  'Plymouth','Pontiac','Porsche','Ram','Rover','Shelby','Studebaker','Subaru','Toyota','Triumph','Tucker','Volkswagen','Willys',
];
