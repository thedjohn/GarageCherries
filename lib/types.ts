...
export const MAKES = [
  'All Makes',
  'Acura','Alfa Romeo','AMC','Auburn','Austin','Austin Healey','BMW','Buick','Cadillac','Chevrolet','Chrysler','Datsun','De Tomaso','DeSoto','Dodge','Factory Five','Fiberfab','Ford',
  'GMC','Hudson','International','Jaguar','Jeep','Kaiser','Kia','Land Rover','Lexus','Lincoln','Lotus','Mazda',
  'Mercedes','Mercury','MG','Mitsubishi','Mitsuoka','Nash','Nissan','Oldsmobile','Packard',
  'Plymouth','Pontiac','Porsche','Ram','Rover','Shelby','Studebaker','Subaru','Toyota','Triumph','Tucker','Volkswagen','Volvo','Willys',
];
