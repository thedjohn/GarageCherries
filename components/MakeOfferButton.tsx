  ...
  return (
    <>
      <button
        ...
        className="w-full border-2 border-zinc-200 hover:border-red-400 text-zinc-700 hover:text-red-600 font-bold py-2.5 rounded-xl transition-colors text-sm flex items-center justify-center gap-2"
      >
