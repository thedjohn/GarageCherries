...
### VIN Verification
- [x] VIN field + inline "Verify VIN" button on the `/sell` form; a plain (non-verifying) VIN field is now also shown on the dealer Add/Edit Vehicle modal and the admin Edit Listing modal (added 2026-07-13)
