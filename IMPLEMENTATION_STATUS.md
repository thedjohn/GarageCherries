...
- [x] **Unit test suite (Vitest)** — `tests/unit/` directory; **49 test files, 831 tests**, all passing (expanded 2026-07-10; coverage: 99.19% statements / 90.61% branches / 96.26% functions / 99.78% lines across `lib/**` + `app/api/**`):
