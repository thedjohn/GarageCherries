...
- [ ] New model pages render with real Live Inventory listings: `/cars/chevrolet/c10`, `/cars/chevrolet/3100`, `/cars/chevrolet/suburban`, `/cars/chevrolet/210`, `/cars/ford/f-100`, `/cars/ford/model-a` (added 2026-08-08); confirm `/cars/gmc/suburban` still renders correctly too (same model name, different make)
