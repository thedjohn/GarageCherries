...
*Updated 2026-08-09 — a wrong-priced social video (Atomic Motors LeBaron) was corrected at its source and re-posted with the right price after Derek deleted the old Facebook/Instagram posts; 8 more events added (North Carolina, now 9 total) using a new fuzzy-name-matching dedup check alongside the existing exact match. No new testable UI surface from either — not added as separate checklist items.*
