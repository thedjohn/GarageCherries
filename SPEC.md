...
> Generated 2026-07-02 from a full read of every route, page, and library file. Last updated 2026-07-21 (three new Car Guide route categories added — `/cars/[bodyStyle]` (convertibles, coupes, pickup-trucks, fastbacks), `/cars/[decade]` (1930s–2010s), `/cars/[priceTier]` (under-10k through 50k-plus) — plus real bug fixes to dealer password reset, Google Merchant Listings schema, and admin panel phone/URL display. See IMPLEMENTATION_STATUS.md for full detail).
